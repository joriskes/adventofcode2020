...
fn main() {
    ...
    match day {
        ...
        15 => day15::run(input_filename),
        16 => day16::run(input_filename),
        17 => day17::run(input_filename),
        18 => day18::run(input_filename),
        19 => day19::run(input_filename),
        20 => day20::run(input_filename),
